...
public:
	...
	project()			//this constructor will make the whole skeleton
	{
		...
		//////////////////////////////////////////////
		cout << endl << "--------------------Welcome to	DHT-----------------------------" << endl;
		cout << "Before we proceed please specify number of identifiers(in bits): ";
		cin >> SpecifierNo;
		...
		///////////////or random////////////////
		cout << "Press Y to manually assign ID to Machine or Press any key to assign machines automatically: ";
		char condition;
		cin >> condition;
	...
	{
		char p = '\0';
		cout << "press y for reading a file to insert Data\n";
		cout << "press u to insert data by yourself\n";
		cin >> p;
		if (p == 'y' || p == 'Y') {
			string c;
		...
		else if (p == 'u' || p == 'U')
		{
			...
			{
				char t = '\0';
				cout << "press n to stop the proces of insertion\n";
				cin >> t;
				if (t == 'n' || t == 'N')
				{
					break;
	...
	void DisplayRouting() {
		for (int i = 0; i < MachineNo; i++)
		{
			cout << "Displaying Routing table for Machine: " << IDptr[i] << endl;
			for (int j = 0; j < MachineNo; j++)
			{
				cout << routing_array[i][j] << " ";
			}
	...
	void deletion(string key)
	{
		...
		if (temp1 == NULL)
		{
			...
			cout << endl << "Deletion Not successful" << endl;
			return;
		}
		...
		cout << endl;
		cout << "\nline number is=" << D->line << endl;
		cout << "File Name is=" << D->FilePath << endl;
		cout << endl;
		//-------------------------------------	------------------
		...
		temp1->obj.Delete(key);
		cout << "Deletion successful from file " << D->FilePath << " and line number is " << D->line << endl;
		//--------------------------------------------------------
	}
	void DisplayMachine()
	{
	...
	void menu()
	{
		...
		while (condition != 'E')
		{
			...
			cout << endl << "				To display routing tables Press (R)";
